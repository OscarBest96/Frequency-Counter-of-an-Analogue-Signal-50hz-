...
for i in 0 to 7 loop -- rising edge of clock every 40ns so each loop reads twice
                     -- This simulates dummy values read from ADC (slave)
MISO <= '1';   -- bit '1' read from MISO 
wait for 20 ns;
MISO <= '0';
wait for 20 ns; 
MISO <= '0';   -- bit '0' read from MISO
wait for 20 ns;
MISO <= '1';
wait for 20 ns; 
